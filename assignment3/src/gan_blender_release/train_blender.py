    ...
    with torch.no_grad():
        ...
        if type == "naive":
            ...
            for combi in combinations:
                ...
                source_img = torch.permute(cv2.imread(f"/content/gdrive/MyDrive/CV_2/images_Emily/{combi[0]}_bg_{combi[2]}.png"),(1,2,0))
                print(source_img.shape)
                source.append(torch.permute(cv2.imread(f"/content/gdrive/MyDrive/CV_2/images_Emily/{combi[0]}_bg_{combi[2]}.png"),(1,2,0)))
                target.append(torch.permute(cv2.imread(f"/content/gdrive/MyDrive/CV_2/images_Emily/{combi[0]}_fg_{combi[1]}.png"),(1,2,0)))
                swap.append(torch.permute(cv2.resize(cv2.imread(f"/content/gdrive/MyDrive/CV_2/images_Emily/{combi[0]}_sw_{combi[2]}_{combi[1]}.png"),(224,224),interpolation = cv2.INTER_AREA),(1,2,0)))
                mask.append(torch.permute(cv2.resize(cv2.imread(f"/content/gdrive/MyDrive/CV_2/images_Emily/{combi[0]}_mask_{combi[2]}_{combi[1]}.png"),(224,224),interpolation = cv2.INTER_AREA),(1,2,0)))
